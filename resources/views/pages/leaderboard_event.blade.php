        ...
        <div class="container">
            <div class="row align-items-center justify-content-start">
                <div class="col-lg-6 mx-auto text-center">
                    ...
                    <h1 class="heading" data-aos="fade-up">Leaderboard {{ $event->title }}</h1>
                    <p class="mb-4" data-aos="fade-up">{!! $event->descritpion !!}</p>
                </div>
            </div>
        </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-3 d-flex justify-content-center align-items-center">
                                        <h5>{{ $post->vote_count === null ? '0' : $post->vote_count }} Votes</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
